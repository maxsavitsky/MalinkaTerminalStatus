...
public class SectionsManager {
	...
	private static class TerminalWrapper implements Terminal {
		...
		public void putCharacter(char c) throws IOException {
			TerminalPosition position = terminal.getCursorPosition();
			if(isInSection(position.getColumn(), position.getRow(), sectionSize))
		...
		private static boolean isInSection(int x, int y, Section.SectionSize sectionSize){
